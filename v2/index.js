...
app.get('/api/sources/:id/results', AuthController.requireAuth, ApiController.getResultsBySource);
...
app.get('/api/templates-message', AuthController.requireAuth, ApiController.getTemplateMessages);
app.post('/api/templates-message', AuthController.requireAuth, ApiController.createTemplateMessage);
